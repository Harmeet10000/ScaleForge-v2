...
import { checkMemory, getApplicationHealth, getSystemHealth } from "../../src/utils/quicker";
...
describe("Health Utils - Unit Tests", () => {
  describe("getSystemHealth", () => {
    ...
    it("should return valid memory values", () => {
      ...
      const totalMemory = Number.parseFloat(health.totalMemory);
      const freeMemory = Number.parseFloat(health.freeMemory);
    ...
    it("should return valid CPU usage percentage", () => {
      const health = getSystemHealth();
      const cpuPercent = Number.parseFloat(health.cpuUsagePercent);
  ...
  describe("getApplicationHealth", () => {
    ...
    it("should return valid memory usage values", () => {
      ...
      const heapTotal = Number.parseFloat(health.memoryUsage.heapTotal);
      const heapUsed = Number.parseFloat(health.memoryUsage.heapUsed);
